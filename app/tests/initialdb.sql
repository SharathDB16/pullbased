...
INSERT INTO `edge_type` VALUES (1,'static','static','default',_binary '#!/bin/bash\n\necho \"======================TAKING BACKUP============================\"\necho \"Executing pre_gen script\"\nsudo rsync -avP --files-from=template_path.txt / \"/opt/sugarbox/provisioningagent/config/backup/etc_baks\"\necho \"Executed pre_gen script\"\necho \"======================BACKUP DONE==============================\"\n\n',_binary '#!/bin/bash\n\necho \"===============================================================\"\necho \"Executing post_gen script\"\nif [ -e /opt/sugarbox/provisioningagent/etc/status_fail.txt ]; then\n	echo \"Restoring backup\"\n	sudo rsync -aAvr /opt/sugarbox/provisioningagent/config/backup/etc_baks/etc/* /etc/\n	sudo rm -fR /opt/sugarbox/provisioningagent/config/backup/etc_baks\nfi\necho \"Executed post_gen script\"\necho \"===============================================================\"\n','2019-01-29 06:24:33','2019-05-30 13:23:51'),(2,'mid','mid','default',_binary '#!/bin/bash\n\necho \"======================TAKING BACKUP============================\"\necho \"Executing pre_gen script\"\nsudo rsync -avP --files-from=template_path.txt / \"//opt/sugarbox/provisioningagent/config/backup/etc_baks\"\necho \"Executed pre_gen script\"\necho \"======================BACKUP DONE==============================\"\n\n',_binary '#!/bin/bash\n\necho \"===============================================================\"\necho \"Executing post_gen script\"\nif [ -e /opt/sugarbox/provisioningagent/etc/status_fail.txt ]; then\n	echo \"Restoring backup\"\n	sudo rsync -aAvr /opt/sugarbox/provisioningagent/config/backup/etc_baks/etc/* /etc/\n	sudo rm -fR /opt/sugarbox/provisioningagent/config/backup/etc_baks\nfi\necho \"Executed post_gen script\"\necho \"===============================================================\"\n','2019-01-29 06:24:33','2019-05-30 13:23:51'),(3,'mobile','mobile','default',_binary '#!/bin/bash\n\necho \"======================TAKING BACKUP============================\"\necho \"Executing pre_gen script\"\nsudo rsync -avP --files-from=template_path.txt / \"/opt/sugarbox/provisioningagent/config/backup/etc_baks\"\necho \"Executed pre_gen script\"\necho \"======================BACKUP DONE==============================\"\n\n',_binary '#!/bin/bash\n\necho \"===============================================================\"\necho \"Executing post_gen script\"\nif [ -e /opt/sugarbox/provisioningagent/etc/status_fail.txt ]; then\n	echo \"Restoring backup\"\n	sudo rsync -aAvr /opt/sugarbox/provisioningagent/config/backup/etc_baks/etc/* /etc/\n	sudo rm -fR /opt/sugarbox/provisioningagent/config/backup/etc_baks\nfi\necho \"Executed post_gen script\"\necho \"===============================================================\"\n','2019-01-29 06:24:33','2019-05-30 13:23:51'),(4,'kontron_metro','mobile','kontronmetro',_binary '#!/bin/bash\n\necho \"======================TAKING BACKUP============================\"\necho \"Executing pre_gen script\"\nsudo rsync -avP --files-from=template_path.txt / \"//opt/sugarbox/provisioningagent/config/backup/etc_baks\"\necho \"Executed pre_gen script\"\necho \"======================BACKUP DONE==============================\"\n\n',_binary '#!/bin/bash\n\necho \"===============================================================\"\necho \"Executing post_gen script\"\nif [ -e /opt/sugarbox/provisioningagent/etc/status_fail.txt ]; then\n	echo \"Restoring backup\"\n	sudo rsync -aAvr /opt/sugarbox/provisioningagent/config/backup/etc_baks/etc/* /etc/\n	sudo rm -fR /opt/sugarbox/provisioningagent/config/backup/etc_baks\nfi\necho \"Executed post_gen script\"\necho \"===============================================================\"\n','2019-01-29 06:24:33','2019-05-30 13:23:51'),(5,'c2cbus','mobile','c2cbus',_binary '#!/bin/bash\n\necho \"======================TAKING BACKUP============================\"\necho \"Executing pre_gen script\"\nsudo rsync -avP --files-from=template_path.txt / \"//opt/sugarbox/provisioningagent/config/backup/etc_baks\"\necho \"Executed pre_gen script\"\necho \"======================BACKUP DONE==============================\"\n\n',_binary '#!/bin/bash\n\necho \"===============================================================\"\necho \"Executing post_gen script\"\nif [ -e /opt/sugarbox/provisioningagent/etc/status_fail.txt ]; then\n	echo \"Restoring backup\"\n	sudo rsync -aAvr /opt/sugarbox/provisioningagent/config/backup/etc_baks/etc/* /etc/\n	sudo rm -fR /opt/sugarbox/provisioningagent/config/backup/etc_baks\nfi\necho \"Executed post_gen script\"\necho \"===============================================================\"\n','2019-01-29 06:24:33','2019-05-30 13:23:51'),(6,'pseudotp','mid','parent_pseudo_tp',_binary '#!/bin/bash\n\necho \"======================TAKING BACKUP============================\"\necho \"Executing pre_gen script\"\nsudo rsync -avP --files-from=template_path.txt / \"//opt/sugarbox/provisioningagent/config/backup/etc_baks\"\necho \"Executed pre_gen script\"\necho \"======================BACKUP DONE==============================\"\n\n',_binary '#!/bin/bash\n\necho \"===============================================================\"\necho \"Executing post_gen script\"\nif [ -e /opt/sugarbox/provisioningagent/etc/status_fail.txt ]; then\n	echo \"Restoring backup\"\n	sudo rsync -aAvr /opt/sugarbox/provisioningagent/config/backup/etc_baks/etc/* /etc/\n	sudo rm -fR /opt/sugarbox/provisioningagent/config/backup/etc_baks\nfi\necho \"Executed post_gen script\"\necho \"===============================================================\"\n','2019-03-04 06:42:31','2019-05-30 13:23:51'),(7,'pseudotp','mid','child_pseudo_tp',_binary '#!/bin/bash\n\necho \"======================TAKING BACKUP============================\"\necho \"Executing pre_gen script\"\nsudo rsync -avP --files-from=template_path.txt / \"//opt/sugarbox/provisioningagent/config/backup/etc_baks\"\necho \"Executed pre_gen script\"\necho \"======================BACKUP DONE==============================\"\n\n',_binary '#!/bin/bash\n\necho \"===============================================================\"\necho \"Executing post_gen script\"\nif [ -e /opt/sugarbox/provisioningagent/etc/status_fail.txt ]; then\n	echo \"Restoring backup\"\n	sudo rsync -aAvr /opt/sugarbox/provisioningagent/config/backup/etc_baks/etc/* /etc/\n	sudo rm -fR /opt/sugarbox/provisioningagent/config/backup/etc_baks\nfi\necho \"Executed post_gen script\"\necho \"===============================================================\"\n','2019-03-04 06:42:40','2019-05-30 13:23:51'),(8,'nuc','static','nuc',_binary '#!/bin/bash\n\necho \"======================TAKING BACKUP============================\"\necho \"Executing pre_gen script\"\nsudo rsync -avP --files-from=template_path.txt / \"/opt/sugarbox/provisioningagent/config/backup/etc_baks\"\necho \"Executed pre_gen script\"\necho \"======================BACKUP DONE==============================\"\n\n',_binary '#!/bin/bash\n\necho \"===============================================================\"\necho \"Executing post_gen script\"\nif [ -e /opt/sugarbox/provisioningagent/etc/status_fail.txt ]; then\n	echo \"Restoring backup\"\n	sudo rsync -aAvr /opt/sugarbox/provisioningagent/config/backup/etc_baks/etc/* /etc/\n	sudo rm -fR /opt/sugarbox/provisioningagent/config/backup/etc_baks\nfi\necho \"Executed post_gen script\"\necho \"===============================================================\"\n','2019-06-13 10:09:25','2019-06-13 10:09:25'),(9,'ct_static','static','ct_static',_binary '#!/bin/bash\n\necho \"======================TAKING BACKUP============================\"\necho \"Executing pre_gen script\"\nsudo rsync -avP --files-from=template_path.txt / \"/opt/sugarbox/provisioningagent/config/backup/etc_baks\"\necho \"Executed pre_gen script\"\necho \"======================BACKUP DONE==============================\"\n',_binary '#!/bin/bash\n\necho \"===============================================================\"\necho \"Executing post_gen script\"\nif [ -e /opt/sugarbox/provisioningagent/etc/status_fail.txt ]; then\n	echo \"Restoring backup\"\n	sudo rsync -aAvr /opt/sugarbox/provisioningagent/config/backup/etc_baks/etc/* /etc/\n	sudo rm -fR /opt/sugarbox/provisioningagent/config/backup/etc_baks\nfi\necho \"Executed post_gen script\"\necho \"===============================================================\"\n\n','2020-01-06 17:56:08','2020-01-06 17:56:14'),(10,'railtel_pilot_ec','mobile','railtel_pilot_ec',_binary '#!/bin/bash\n\necho \"======================TAKING BACKUP============================\"\necho \"Executing pre_gen script\"\nsudo rsync -avP --files-from=template_path.txt / \"/opt/sugarbox/provisioningagent/config/backup/etc_baks\"\necho \"Executed pre_gen script\"\necho \"======================BACKUP DONE==============================\"\n',_binary '#!/bin/bash\n\necho \"===============================================================\"\necho \"Executing post_gen script\"\nif [ -e /opt/sugarbox/provisioningagent/etc/status_fail.txt ]; then\n	echo \"Restoring backup\"\n	sudo rsync -aAvr /opt/sugarbox/provisioningagent/config/backup/etc_baks/etc/* /etc/\n	sudo rm -fR /opt/sugarbox/provisioningagent/config/backup/etc_baks\nfi\necho \"Executed post_gen script\"\necho \"===============================================================\"\n\n','2020-03-11 07:30:57','2020-03-11 07:32:21');
...
-- Dump completed on 2021-05-21  8:12:07
